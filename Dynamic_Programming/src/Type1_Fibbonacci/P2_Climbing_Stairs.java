...
public class P2_Climbing_Stairs {
	...
	// Recursion
	public static int climbingStairs(int n, int i) {
	...
	// Memoization
	public static int climbingStairsMemo(int n, int i, int[] memo) {
		...
		memo[i] = climbingStairsMemo(n, i + 1, memo) + climbingStairsMemo(n, i + 2, memo);
